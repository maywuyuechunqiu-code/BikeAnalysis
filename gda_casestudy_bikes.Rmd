...
fg1 <- ggplot(pivot_table, aes(x = usertype, y = Mean_min, fill = usertype)) +
  geom_col(width = 0.6) +
  labs(
...
# Average ride length by year and user type
fg1a <- ggplot(pivot_table2, aes(x = factor(Year), y = Mean_min, fill = usertype)) +
  geom_col(position = "dodge") +
  labs(title = "Average Ride Length of Casual and Member Users (2019 Q1 vs 2020 Q1)",
       x = "Year",
...
fg2 <- ggplot(pivot_table, aes(x = usertype, y = Mean_min, fill = usertype)) +
  ...
  labs(
    title = "Average Ride Length by User Type Across Weekdays",
...
# First, there is an overall comparison by user type
fg3<- ggplot(pivot_table2, aes(x = factor(Year), y = Count, fill = usertype)) +
  geom_col(position = "dodge") +
  labs(
    title = "Number of Rides by User Type (2019 Q1 vs 2020 Q1)",
    x = "Year",
    y = "Count of Rides",
    fill = "User Type"
  ) +
...
#  Boxplot: Weekly ride count by user type
fg3a <- ggplot(weekday_counts,
       aes(x = day_of_week, y = Count, fill = usertype)) +
  geom_col(position = "dodge") +
  labs(
    title = "Number of Rides by Day of Week and User Type (2019 Q1 & 2020 Q1)",
    #subtitle = "Comparison between Casual and Member users (2019 Q1 vs 2020 Q1)",
    x = "Day of Week",
    y = "Number of Rides",
    fill = "User Type"
  ) +
